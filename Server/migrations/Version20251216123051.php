 ...
 */
final class Version20251216123051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, icone VARCHAR(255) NOT NULL, couleur VARCHAR(255) NOT NULL, ordre_affichage INT NOT NULL, actif TINYINT(1) NOT NULL, date_creation DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE circuits (id INT AUTO_INCREMENT NOT NULL, duree_jours DOUBLE PRECISION NOT NULL, prix_base DOUBLE PRECISION NOT NULL, difficulte INT NOT NULL, score_ecotourisme DOUBLE PRECISION NOT NULL, actif TINYINT(1) NOT NULL, date_creation DATETIME NOT NULL, titre VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, meto_titre VARCHAR(255) NOT NULL, meta_description VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE devis (id INT AUTO_INCREMENT NOT NULL, reference_devis VARCHAR(255) NOT NULL, nom_client VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, dates_souhaitees DATETIME NOT NULL, nombres_adultes INT NOT NULL, nombre_enfants INT NOT NULL, nombre_bebes INT NOT NULL, statut VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, client_id INT DEFAULT NULL, INDEX IDX_8B27C52B19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE reservations (id INT AUTO_INCREMENT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME DEFAULT NULL, nombre_adultes INT NOT NULL, nombre_enfants INT NOT NULL, nombre_bebes INT NOT NULL, statut TINYINT(1) NOT NULL, date_creation DATETIME NOT NULL, client_id INT NOT NULL, circuit_id INT NOT NULL, INDEX IDX_4DA23919EB6921 (client_id), INDEX IDX_4DA239CF2182C8 (circuit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE services (id INT AUTO_INCREMENT NOT NULL, icone VARCHAR(255) NOT NULL, actif TINYINT(1) NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, ordre_affichage INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
