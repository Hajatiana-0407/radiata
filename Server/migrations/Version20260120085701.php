 ...
 */
final class Version20260120085701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservations (id INT AUTO_INCREMENT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME DEFAULT NULL, nombre_adultes INT NOT NULL, nombre_enfants INT NOT NULL, nombre_bebes INT NOT NULL, statut TINYINT(1) NOT NULL, date_creation DATETIME NOT NULL, hebergement VARCHAR(255) DEFAULT NULL, circuit_id INT NOT NULL, client_id INT DEFAULT NULL, INDEX IDX_4DA239CF2182C8 (circuit_id), INDEX IDX_4DA23919EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
