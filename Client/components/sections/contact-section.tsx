...
export function ContactSection() {
  return (
    <section className="py-20 px-4 bg-linear-to-br from-slate-50 to-white relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="h-full">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl h-full min-h-125 animate-fade-in">
              <img
          ...
          {/* Right: Contact Form */}
          <div className=" bg-white p-8 rounded-2xl shadow-xl animate-slide-in-right">
